<div class="rbd-courses">
    <div id="banner-grid" class="py-5 px-2 bg-red mb-5">
        <h2 class="text-center text-uppercase text-white">Accredited Online Courses</h2>
    </div>
    <div class="container">
        <div class="row mt-md-5 mt-3">
            <div class="col-md-8">
							<h2>Latest Accredited Online Courses:</h2>
                    ...
                    <?php 
							...
							foreach($courselisting as $cour){
								...
								if(file_exists('./assets/images/ce_provider/'.$cour->course_image)){
									$banner = '<img src="'.base_url().'assets/images/ce_provider/'.$cour->course_image.'">';
								}
								echo '<div class="col-4">
											<div class="common-main-box">
												<a href="'.base_url('course/'.$cour->cor_doc_id).'">
													<div class="imag-panel">'.$banner.'
													<div class="img-disp-hover">'.ucwords($cour->course_title).'<br>CE Units :'.$cour->course_units.'
													</div>
													</div>
													</a>
