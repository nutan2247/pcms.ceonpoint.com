...
<div class="row" id="view_license_content">
                ...
                if($result['type']=='p'){
                    $photo=base_url('assets/images/graduates/'.$result['image']);
                }else{
                    $photo = base_url('assets/uploads/profile/'.$result['image']); 
                }
                    ...
                    <tbody style="border: 1px solid #ddd;">
                        <tr>
                            <td style=" width: 28%; padding: 30px 0 0 30px; "><img src="<?php echo $photo;?>"
                                    alt="<?php echo ucwords($result['fullname']); ?>" style="width: 100%;">
                                <p style="margin-top: 10px; font-weight: bold; text-align: center; font-size: 20px; ">
                                    <?php echo (!empty($result['licenseno']))?$result['licenseno']:$result['examcode'];?>,
                            ...
                            <td style="padding-left: 40px; padding-top: 50px;">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        <?php if($result['type']=='pp'){?>
                                            <td style="padding: 4px 0;border: none;width: 35%; font-size: 20px;"> License No.</td>
                                            <td style="padding: 0;border: none; font-size: 20px; font-weight: bold;">
                                                <?php echo $result['licenseno'];?>
                                            </td> <?php }else{?>
                                            <td style="padding: 4px 0;border: none;width: 35%; font-size: 20px;">Exam Code</td>
                                            <td style="padding: 0;border: none; font-size: 20px; font-weight: bold;">
                                        ...
                                        <?php if($result['expiry_at'] != '0000-00-00'){
                                $validity_date = date('M d,Y',strtotime($result['expiry_at']));
                            }else{
                                $validity_date = '--';
                            } ?>
                                        <tr>
