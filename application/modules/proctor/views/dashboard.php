                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mx-auto">
                                ...
                                if($details->user_type == 'pp'){
									...
									$heading = 'Foriegn Professional Examinees Listing'; 
									$type = 'pp';
								}else{ 
                                    $ptype = 'Proctor for Graduates'; 
									$heading = 'Graduates Examinees Listing'; 
									$type = 'p';
								}
                            ...
                            <div class="col-md-3 mx-auto text-center">
                                <div class="a-box">
                                    <button type="button" class="btn btn-info px-5"><?php echo count($total_exam);?></button>
