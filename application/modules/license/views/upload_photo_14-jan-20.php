    ...
    <div class="col-md-8 mx-auto">
        ...
        <div class="my-5">
            ...
            <div class="required-box p-4 rounded mb-5">
                ...
                <?php echo form_open_multipart('license/landing/update_photo?user_id='.$this->input->get('user_id'),array('id'=>'contact_form')); ?>

                <div class="form-group row">
                    <input type="hidden" name="user_id" value="<?php echo $this->input->get('user');?>">
                    <div class="col-sm-2">
            ...
            ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <img src="<?php echo base_url('assets/images/profile/').$udetails->image; ?>" id="usersPhoto">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-10">
                        ...
                        <a href="<?php echo base_url('license/landing/required_units/?user_id='.$this->input->get('user_id'));?>" class="btn btn-primary text-uppercase">Next</a>
                    </div>
                </div>
