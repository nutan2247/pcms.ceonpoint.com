	...
	<div class="container mb-5">
        ...
        <tr style="text-align: center;">
            <td>
                <h1 style="font-size: 30px; font-weight: 700; margin: 0; "><?php echo $course_details->course_title; ?>
                </h1>
                ...
                <p style="font-size: 20px;margin: 29px 0;font-family: 'Montserrat', sans-serif;font-weight: 400;">
                    Granted this <br> <?php echo date('F j, Y',strtotime($course_details->review_date));?>
                </p>
                <p style="margin-top: 5px;font-size: 21px;font-family: 'Montserrat', sans-serif;font-weight: 600;">
                    ACCREDITATION NO. : <?php echo $course_details->refrence_code;?> <br> VALIDITY : <?php echo date('F j, Y',strtotime($course_details->expiry_at));?> </p>
        ...
        <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 40%; padding-bottom: 25px;">
                            ...
                            <p style="color: #f2cd1f;font-size: 19px; font-weight: 600; font-family: 'Montserrat', sans-serif; text-transform: uppercase; letter-spacing: 1.1px; margin: 0;">
                                <?php echo $course_details->refrence_code;?></p>
                        </td>
                    </tr>
                </table>
            </td>
			...
			<?php
				...
				//// start course certificate section
					//echo '<p>Course Name :'.$course_details->course_title.'</p>';
				//	echo '<p>Unit: '.$course_details->course_units.'</p>';
					//echo '<p>Acceditation no.'.$course_details->course_acceditation_number.'</p>';
				//	echo '<p>Validity:'.$course_details->expiry_at.'</p>';
