        ...
        <div class="my-5">
			...
			<?php
				...
				if($unvdetls->reviewer_status == 2){
					echo '<span class="rejectedbtn">ACCEPTED</span>';
				}
				if($unvdetls->reviewer_status == 1){
					echo '<p class="text-center">Your application for School Accreditation has been <strong>PPROVED.</strong></p>
                    <a href="'.base_url('university/university/digitalaccreditation/'.base64_encode($unvdetls->uniid)).'"><span class="statusbtn statusbtn2">Click here to view certificate</span></a>';
				}
			?>
