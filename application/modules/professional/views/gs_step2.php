...
<div class="container">
    <div class="col-md-8 mx-auto">
        <div class="my-5 ">
            ...
            <form action="<?php echo base_url('professional/applicant/gsreceipientInformation'); ?>" id="receipientInformationFormsData" enctype="multipart/form-data" method="post">
