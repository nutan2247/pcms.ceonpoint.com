    ...
    <div class="bg-light py-4">
        <div class="col-md-8 mx-auto form-heigte">
            <div class="my-0">
                ...
                <form action="<?php echo base_url('professional/applicant/add_application'); ?>"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="reg_address" name="reg_address"><?php echo isset($details->reg_address)?$details->reg_address:''; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10"> 
                            <input type="text" class="form-control" id="reg_website" name="reg_website" placeholder="https://" value="<?php echo isset($details->reg_website)?$details->reg_website:''; ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="display:none;" id="other_university">
                        <label class="col-sm-2 col-form-label">Other University Name</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">College of <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row" style="display:none;" id="other_college">
                        <label class="col-sm-2 col-form-label">Other College</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Address<span class="text-danger"></span></label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="university_address" name="university_address"><?php echo isset($details->university_address)?$details->university_address:''; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Website</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="university_website" name="university_website" placeholder="https://" value="<?php echo isset($details->university_website)?$details->university_website:''; ?>" >
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <button type="submit" class="btn btn-success text-uppercase" name="submit" value="save_data">Submit</button>
                        </div>
                    </div>
...
<script>
    ...
    $( document ).ready(function() {
        $("#submitFormPersonal").click(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>professional/applicant/add_application",
                data: formData,
                processData: false,
                contentType: false,
                beforeSend:function(){
                ...
                success: function(result) {
                    ...
                    console.log(obj);
                    if(obj.success==true){
                        window.location.href = "<?php echo base_url();?>professional/applicant/upload_documents";
                        // $('#staticBackdrop').modal('hide');
                        // var src = "<?php echo base_url();?>professional/applicant/upload_documents";
        ...
        //      $.ajax({
        //         type: "POST",
        //         url: "<?php echo base_url();?>license/landing/checkEmail",
        //         data: { email : email },
        //         success: function(data) {
        //             if(data > 0){
        //                 $('#form-error').css('display','block').html('Your Username is already on this server!');
        //                 $('#verifyDetails').hide();
        //                 return false;
        //             }else{
        //                 $('#form-error').html('');
    ...
    $(document).on("click","#verifyDetails",function(){
        ...
        var path = "<?php echo base_url('contactus?'); ?>";
    ...
    function goToUploadDocuments(uid){
        window.location.href="<?php echo base_url();?>professional/applicant/upload_documents/"+uid;
    }
