...
<div class="bg-light py-4">
    <div class="col-md-8 mx-auto">
        <div id="payment-details">
            ...
            <?php echo form_open(base_url('professional/applicant/vrPayment')); ?>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            data: {
                chargeid: chargeid,
                charges_for: 'professional_verification_registration'
            },
            beforeSend: function() {
                $(".loding-main").show();
            },
    ...
    function payByStrip() {
        ...
        window.location.href =url+'?uid='+uid+'&&uname='+uname+'&&price='+total+'&&tax='+tax+'&&type=Request for verification of registration';
