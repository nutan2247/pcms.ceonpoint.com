    ...
    if($this->session->userdata('app_session')){
        ...
        <div id="banner-grid" class="py-5 px-2 bg-red online-red-banner mb-5"> 
            <div class="container">
                ...
                <!--<h3 class="text-center text-uppercase text-white">Foreign Professional Review for Online Examination </h3>-->
                <h3 class="text-center text-uppercase text-white">Booking for Online Licensure Examination (Foreign Professionals) </h3>
