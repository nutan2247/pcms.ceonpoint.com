...
<html lang="en"><head>
    ...
    <div class="row" id="view_license_content">
            <?php
                ...
                if(isset($profes_details->card_qrcode)){
                    $licensebarcode = base_url('assets/qrcode/'.$profes_details->card_qrcode);
                }else{
                    $licensebarcode = '';
                }
                        ...
                        <tr>
                            ...
                            <td style="">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td style="padding: 8px 0;border: none; font-size: 17px;">First Name:
                                            </td>
                                            <td style="padding: 0;border: none; font-size: 17px; font-weight: bold;">
                                                <?php echo ucwords($profes_details->fname);?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 8px 0;border: none; font-size: 17px;">Middle Name:
                                            </td>
                                            <td style="padding: 0;border: none; font-size: 17px; font-weight: bold;">
                                                <?php echo ucwords($profes_details->lname);?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 8px 0;border: none; font-size: 17px;">Surname:
                                            </td>
                                            <td style="padding: 0;border: none; font-size: 17px; font-weight: bold;">
                                                <?php echo ucwords($profes_details->name);?>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 8px 0; border: none; font-size: 17px;">Profession:
                                            </td>
                                            <td style="padding: 0; border: none; font-size: 17px; font-weight: bold;">
                                                <?php echo $profes_details->profession_name; ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                            <td style="padding-left:0; text-align:right;"><img src="<?php echo showimage($licensebarcode); ?>" alt="" style="width: 150px;"></td>
                        </tr>
                    </tbody>
                </table><?php 
