...
$(document).ready(function () {
    var calendar = $('#calendar').fullCalendar({
        ...
        // eventLimit: true,
        events: "<?php echo base_url('professional/calender/fetch_event'); ?>",
        ...
        select: (start, end, allDay) => {
            ...
            var application_id = '<?php echo $grad_id; ?>';
                $.ajax({
                    url: '<?php echo base_url('professional/calender/add_event');?>',
        ...
        //             $.ajax({
        //                 url: '<?php echo base_url('professional/calender/edit_event');?>',
        ...
        //         $.ajax({
        //             type: "POST",
        //             url: "<?php echo base_url('professional/calender/delete_event');?>",
        //             data: "&id=" + event.id,
        //             success: function (response) {
