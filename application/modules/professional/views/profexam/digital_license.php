    ...
    <div class="bg-light py-4">
        <div class="col-md-8 mx-auto">
           <div class="text-center">
                ...
                <h5 class="text-right"> Refrence Code: <b><?php echo $profes_details->refrence_code; ?></b> </h5>
    ...
    <table style="  width: 650px; padding:60px 15px 0 15px; display:block;margin: 0 auto; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
        ...
        <tr style="text-align: center;">
            <td>
                <h1 style="font-family: 'Tangerine', cursive; font-size: 48px;font-weight: 700; margin: 0; "><?php echo ucwords($profes_details->name);?></h1>
                <span
                    style="border-top: 1px dotted #d2d2d2;width: 70%;height: 1px;display: block;margin: 0 auto;margin-top: 18px;"></span>

                <p
                    style=" font-size: 19px;color: #0d0d0d; margin-top: 20px; font-weight: 500; font-family: 'Montserrat', sans-serif;">
                    Hereby Granted Accreditation as
                </p>
                <p
                    style="font-size: 23px;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;">
                    Countinuing Education Professional.
                </p>
