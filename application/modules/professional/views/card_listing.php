                        ...
                        <table class="table table-border">
                            ...
                            if(!empty($doc)){
                                //foreach($alllicense as $value){ 
                                    if($doc->expiry_at != '0000-00-00'){
                                        $expiry = $doc->expiry_at;
                                ...
                                <tr>
                                    ...
                                    <td><?= $cardstatus; ?> </td>
                                    <td> <a href="javascript:void(0)" title="License Card" class="btn btn-info upload-cert"  data-id="<?=$doc->refrence_code;?>" ><i class="fa fa-eye"></i></a> </td>
                                </tr>
