<div class="row" id="view_certificate_content">
    ...
    <link
        ...
        <?php $bg = base_url('assets/images/banner.png'); 
            ...
            $barcode = base_url('assets/qrcode/'.$result->cep_qrcode);
                ?>
    <table style="  width: 700px; padding:20px 15px 0 0px; margin: 0 auto 0px; background-image: url('<?php echo showimage($bg); ?>'); background-repeat: no-repeat; background-size: cover;">
        <tr>
            <th>
        ...
        <tr>
            <td>
                <table style="width: 461px;margin: 0 auto;margin-top: 6px; padding-left:5px;">

                    <tr>
                        <td><img src="<?php echo showimage($certificate_text); ?>" alt="" style=" width: 70%; "></td>
		...
		<tr style="text-align: center;">
            <td>
                <h1 style="font-size: 30px; font-weight: 700; margin: 0; "><?php echo ucwords($result->business_name);?></h1>
                ...
                <p style="font-size: 17px;color: #0d0d0d;margin-top: 20px;font-weight: 500;font-family: 'Montserrat', sans-serif;max-width: 50%;margin: 18px auto;">
                    Is hereby granted accreditation as Continuing Education Provider.
                </p>
                <p style="font-size: 20px;margin: 15px 0;font-family: 'Montserrat', sans-serif;font-weight: 400;">
                    Granted this <br> <?php echo date("F d, Y", strtotime($result->review_date));?>
                </p>
                <p style="margin-top: 5px;font-size: 21px;font-family: 'Montserrat', sans-serif;font-weight: 600;">
                    ACCREDITATION NO. : <?php echo $result->accreditation_no;?> <br> VALIDITY: <?php echo date("F d, Y", strtotime($result->expiry_at));?> </p>
        ...
        <tr>
            <td>
                <table style="width: 540px; margin: 0 auto; margin-top: 15px; margin-bottom: 40px;">
                    <tr>
                        <td
        ...
        <tr>
            <td>
                <table style="
                width: 90%; margin: 0 auto; padding-top: 40px; padding-bottom: 5px; ">
                    <tr>
                        <td style="text-align: left;width: 60%;">
                            <!-- <img src="images/footer-logo.png" alt="" style=" padding-top: 19px; "> -->
                            <!-- <p style=" padding-top: 55px;" ></p> -->
                            <p
                                style=" color: #fff; font-size: 18px; margin: 60px 0 0 0; font-family: 'Montserrat', sans-serif; ">
                                validate this certificate at:</p>
                            <a href="#"
                                style="color: #f2cd1e; font-size: 17px; font-family: 'Montserrat', sans-serif; "><?php echo base_url('license/search');?></a>
                        </td>
                        <td style="text-align: right; width: 40%;">
                            <img src="<?php echo showimage($barcode); ?>" alt="" style=" width: 60px">
                            <p
                            ...
                            <p
                                ...
                                <?php echo $result->accreditation_no; ?></p>
                        </td>
                    </tr>
                </table>
            </td>
