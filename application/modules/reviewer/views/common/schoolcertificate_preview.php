...
<div class="row" id="view_certificate_content">
        <?php $bg = base_url('assets/images/banner.png'); 
            ...
            $barcode = base_url('assets/qrcode/'.$result->accr_qrcode);
                ?>
    ...
    <tr>
     ...
     <tr>
      ...
      <tr>
        <td align="center">
                ...
                <p style="margin-top: 5px;font-size: 16px;font-family: 'Montserrat', sans-serif;font-weight: 600;">ACCREDITATION NUMBER :  <?php echo $result->accreditation_number; ?> </p>
				<p style=" font-size: 15px;color: #0d0d0d; margin-top: 20px; font-weight: 500; font-family: 'Montserrat', sans-serif;">Date Issued: <?php echo date("M d, Y", strtotime($result->review_accept_date));?></p>
				<p style=" font-size: 15px;color: #0d0d0d; margin-top: 20px; font-weight: 500; font-family: 'Montserrat', sans-serif;">Validity Date: <?php echo date("M d, Y", strtotime($result->expiry_at));?></p>
     ...
     <tr>
        <td>
        <table style="
                width: 90%; margin: 0 auto; padding-top: 90px; padding-bottom: 10px; ">
                    <tr>
                        <td style="text-align: left;width: 70%; padding-top: 60px">
                            <!-- <img src="images/footer-logo.png" alt="" style=" padding-top: 19px; ">  -->
                            <!-- <p style=" padding-top: 55px;" ></p> -->
                            <p style=" color: #fff; font-size: 18px; margin: 60px 0 0 0; font-family: 'Montserrat', sans-serif;">
