    ...
    <main>
        <div class="container-fluid">
                ...
                <div class="col-md-12 mx-auto v-div">
                    <div class="row mt-3 pb-3">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-2">
                                    <?php $rvd = $requestverificationdocument; //print_r($rvd);exit;
                                        if(!empty($rvd->image))
                                        {
                                    ?>
                                    <div class="border border-primary"><img
                                            src="<?php echo base_url('assets/uploads/profile/').$rvd->image; ?>"
                                            width="100%"></div>
                                        <?php } ?>
                                </div>
                                <div class="col-md-8">
                                    <h4><?php echo ucwords(!empty($rvd)?$rvd->fname.' '.$rvd->lname.' '.$rvd->name:"--"); ?>
                                    </h4>

                                    <p><b>Profession:</b>

                                        <?php echo (!empty($rvd)?$rvd->profession_name:""); ?>
                                        <br><b>License No:</b>
                                        <?php echo (!empty($rvd)?$rvd->license_no:""); ?><br>
                                        <b>Validity:</b>
                                        <?php echo (!empty($rvd)?date('M d,Y',strtotime($rvd->license_validity_date)):""); ?>
                                    </p>
                                </div>
                            </div>
            ...
            <div class="card">
                ...
                <form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo base_url('reviewer/reviewer/verify_requestforverification/'.$rvd->ri_id);?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                           <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <span><?=$rvd->inspurpose ?></span>
                            </div>
                        </div>
                    </div>
                    <?php 
                    if(isset($rvd->reviewer_id) && $rvd->reviewer_id > 0 && $rvd->reviewer_id == $this->session->userdata('login')['user_ID']){ 
					?>
                    <div class="form-group">
                        <div class="row">
                           <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-6 col-sm-5">
                            <input type="hidden" name="ri_id" id="ri_id" value="<?php echo $rvd->ri_id; ?>">
                            <input type="hidden" name="user_id" id="user_id" value="<?php echo $rvd->user_id; ?>">
                            <input type="hidden" name="email" id="email" value="<?php echo $rvd->email; ?>">
                            <input type="hidden" name="proname" id="proname" value="<?php echo $rvd->fname.' '.$rvd->lname.' '.$rvd->name; ?> ">
