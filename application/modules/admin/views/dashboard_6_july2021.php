    ...
    <main>
        <div class="container-fluid mt-4">
            <div class="dashboard-counter">
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <h4 class="text-center my-2 "><span class="d-inline-block border-bottom pb-2 px-3">ADMIN TRACKER</span>
                        </h4>
            ...
            <h5 class="btn-warning text-light p-2 mt-4 online-appication-btn">ONLINE APPLICATIONS (
				...
				$total_application = $newonlineapplication+$reviewedonlineapplication;
                ...
                <div class="col-md-10 mx-auto">
                    <div class="d-flex justify-content-between mt-4">
						<div class="text-center">
                            <div class="a-box">
                                <button type="button" class="btn btn-success px-5">
                                    <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="New Applications">'.$total_new_foreign_professional.'</span>'; ?> / <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="Reviewed Applications">'.($total_approved_foreign_professional+$total_reject_foreign_professional).'</span>'; ?> / <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="All Applications">'.($total_new_foreign_professional+$total_approved_foreign_professional+$total_reject_foreign_professional).'</span>';?>
                                </button>
                        ...
                        <!--<div class="text-center">
                            <div class="a-box">
                                <button type="button" class="btn btn-success px-5">
                                    <?php echo $total_local_professional;?>
                                </button>
                                <p class="mt-2">LOCAL PROFESSIONAL <br>REGISTRATION </p>
                            </div>
                        </div>-->
                ...
                <div class="col-md-10 mx-auto">
                    <div class="d-flex justify-content-between mt-4">
						<div class="text-center">
                            <div class="a-box">
                                <button type="button" class="btn btn-success px-5">
                                   <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="New Applications">0</span>'; ?> / <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="Reviewed Applications">0</span>'; ?> / <?php echo '<span data-toggle="tooltip" data-placement="bottom" title="All Applications">0</span>';?>
                                </button>
            ...
            <h5 class="bg-secondary text-light p-2 mt-2 online-appication-btn text-uppercase">Online licensure examination
                <a href="<?php echo site_url('admin/examinees_listing'); ?>"><button class="btn btn-primary float-right">View</button></a>
            </h5>
            <div class="row round-btn">
				<?php
					
					foreach($get_examschedule as $scdule){
						$no_graducate = 0;
						$no_professional = 0;
						$no_graducate_pass = 0;
						...
						foreach($get_bookedexam as $booked){
							if($scdule->es_id == $booked->examination_id){
								if($booked->booking_for == 'p'){
									$no_graducate++;
								}
								if($booked->booking_for == 'pp'){
									$no_professional++;
								}
							}
						}
						foreach($get_passedexam as $pass){
							if($scdule->es_id == $pass->examination_id){
								if($pass->booking_for == 'p'){
									$no_graducate_pass++;
								}
								if($pass->booking_for == 'pp'){
									$no_professional_pass++;
								}
							}
						}
						
						$section = ($scdule->exam_for == 'pp')?'Foreign Professionals':'Local Graduates';
						$countexaminer = ($scdule->exam_for == 'pp')?$no_professional:$no_graducate;
						$countpass = ($scdule->exam_for == 'pp')?$no_professional_pass:$no_graducate_pass;
						...
						echo '<div class="col-md-6">
								...
								<h3 class="text-center my-3">Date : '.date('M d, Y',strtotime($scdule->date)).'</h3><p class="text-center">'.$scdule->start_time.' - '.$scdule->end_time.'</p><p class="text-center">'.$scdule->venue.'</p><p class="text-center"><hints>'.$section.'</hints></p>
								</div>
								<div class="d-flex mt-4">
									...
									<div class="text-center w-50">
										<div class="a-box">
											<button type="button" class="btn btn-primary px-5">0</button>
