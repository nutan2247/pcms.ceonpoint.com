...
<div id="layoutSidenav_content">
    ...
    <div class="clearfix">
        ...
        <a class="btn btn-primary mt-4 mb-2 float-right" href="<?php echo base_url('admin/guidlineheading'); ?>" >Back</a>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea name="content" class="form-control" id="content" placeholder="Please write here..."> </textarea>  
                        </div>
