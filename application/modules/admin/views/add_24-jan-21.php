                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                ...
                                <input type="radio" name="status" id="status_<?php echo $value['professional_status_id']; ?>" value="<?php echo $value['professional_status_id']; ?>" <?php echo (isset($listing->status) && $listing->status==$value['professional_status_id'])? 'checked="checked"':''; ?>> <?php echo $value['name'];?>
