                    ...
                    <div class="tab-pane fade show active" id="pills-pending" role="tabpanel" aria-labelledby="pills-all-tab">
                        <div class="card-header">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <a href="<?=base_url('admin/graduate_examiness_result').'?id=1'?>" class="btn btn-<?=(isset($_GET['id']) && $_GET['id']==1)?'primary':'warning'; ?>">Latest</a>
                                    <a href="<?=base_url('admin/graduate_examiness_result').'?id=2'?>" class="btn btn-<?=(isset($_GET['id']) && $_GET['id']==2)?'primary':'warning'; ?>">Computer Based</a>
                                    <a href="<?=base_url('admin/graduate_examiness_result').'?id=3'?>" class="btn btn-<?=(isset($_GET['id']) && $_GET['id']==3)?'primary':'warning'; ?>">Paper Based</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered adminDT" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>S.No.</th>
                                            <th>Photo</th>
                                    ...
                                    if(!empty($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript:void(0);" class="resultsend" data-id="<?= $list->exam_result; ?>" id="<?= $list->er_id; ?>" value="<?= $list->email; ?>" name="<?=$list->exam_name ?>" examdate="<?=$examdate?>" regcode="<?=$list->registration_code ?>" validity="<?=$list->validity ?>" time="<?=$exam_start_time?>" venue="<?=$list->exam_venue ?>" score="<?=$list->obtained_marks?>" per="<?=$list->percentage?>">Send Result</a>
                                                <a href="javascript:void(0);" class="resultview" data-id="<?= $list->id; ?>" data-type="<?= $list->user_type; ?>">View Result</a></td>
                                        </tr>
