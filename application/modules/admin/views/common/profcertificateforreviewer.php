		...
		<tr style="text-align: center;">
            <td>
                ...
                <p style="font-size: 20px;margin: 29px 0;font-family: 'Montserrat', sans-serif;font-weight: 400;">
                    Granted this <br> <?php echo date("F d, Y", strtotime($result[0]->added_on));?>
                </p>
                <?php $validity='N/A';if($result[0]->expiry_at != '0000-00-00'){
                    $validity=date("F d, Y", strtotime($result[0]->expiry_at));}?>
                <p style="margin-top: 5px;font-size: 21px;font-family: 'Montserrat', sans-serif;font-weight: 600;">
                    ACCREDITATION NO. : <?php echo $result[0]->registration_no;?> <br> VLDIDTY: <?php echo $validity;?> </p>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 40%;">
                            ...
                            <p
                                ...
                                <?php echo $result[0]->refrence_code; ?></p>
                        </td>
                    </tr>
                </table>
            </td>
