    ...
    <table style="  width: 700px; padding:60px 15px 0 15px; margin: 0 auto 38px; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
		...
		<tr style="text-align: center;">
            <td>
                ...
                <h1 style="font-size: 30px; font-weight: 700; margin: 0; "><?php echo ucwords($result->name);?></h1>
                ...
                <p style="font-size: 20px;margin: 29px 0;font-family: 'Montserrat', sans-serif;font-weight: 400;">
                    Granted this <br> <?php echo date("F d, Y", strtotime($result->review_accept_date));?>
                </p>
                <p style="margin-top: 5px;font-size: 21px;font-family: 'Montserrat', sans-serif;font-weight: 600;">
                    ACCREDITATION NO. : <?php echo $result->refrence_code;?> <br> VLDIDTY: <?php echo date("F d, Y", strtotime($result->expiry_at));?> </p>
