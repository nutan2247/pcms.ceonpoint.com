    ...
    <table style="  width: 95%; padding:60px 15px 0 15px; margin: 0 auto 38px; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
		...
		<tr style="text-align: center;">
            <td>
                ...
                <h1 style="font-size: 48px; font-weight: 700; margin: 0; font-family: 'Tangerine', cursive; "><?php echo $result[0]['name'];?></h1>
                ...
                is now eligible for <br> Professional Registration<?php //echo $result[0]['profession_name'];?>
                </p>
                ...
                <?php //$validity='N/A';if($result->expiry_at != '0000-00-00'){
                    //$validity=date("M-d-Y",strtotime($result->expiry_at));}?>
                <p style="font-size: 19px;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;">
                    <?php if($result[0]['type'] == 'g'){?>
                    Exam Code : <strong>
                    <?php echo $result[0]['examcode'];}
                    else{ ?>
                    Registration Number : <strong>
                    <?php echo $result[0]['registration_no']; }?>
                    </strong><br>
                                Validity : <strong>
                                    <?php echo $result[0]['validity']; ?>
                                </strong>
                            </p>
