    ...
    <table style="  width: 95%; padding:60px 15px 0 15px; margin: 0 auto 38px; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
		...
		<tr style="text-align: center;">
            <td>
                ...
                <h1 style="font-size: 30px; font-weight: 700; margin: 0; "><?php echo $result->student_name.' '.$result->middle_name.' '.$result->surname;?></h1>
                ...
                <?php $validity='N/A';if($result->validity != ''){
                    $validity = date("M d,Y",strtotime($result->validity));
                    }else{
                        $validity = date("M d,Y",strtotime($result->reviewer_accept_date . ' + 1 year'));
                    } ?>
                <p style="font-size: 19px;color: #2e85c1; margin-top: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600;">
                    ...
                    <?php echo ($result->registration_no)?$result->registration_no:'N/A';?>
                    </strong><br>
                                Validity : <strong>
                                    <?php echo $validity; ?>
                                </strong>
                            ...
                            <p style=" margin-top: 5px; font-size: 17px; font-family: 'Montserrat', sans-serif;">Granted
                                ...
                                <?php echo date('M d,Y',strtotime($result->reviewer_accept_date)); ?>
                            </p>
                            <p
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; width: 40%;">
                            ...
                            <p
                                ...
                                <?php echo ($result->registration_no)?$result->registration_no:'N/A';?></p>
                        </td>
                    </tr>
                </table>
            </td>
