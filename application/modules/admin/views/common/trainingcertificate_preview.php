<div class="row" id="view_certificate_content">
    ...
    <table style="  width: 700px; padding:60px 15px 0 15px; margin: 0 auto 38px; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
		...
		<tr style="text-align: center;">
            <td>
                <h1 style="font-size: 30px; font-weight: 700; margin: 0; "><?php echo ucwords($result->training_title);?></h1>
                ...
                <p style="font-size: 17px;color: #0d0d0d;margin-top: 20px;font-weight: 500;font-family: 'Montserrat', sans-serif;max-width: 50%;margin: 18px auto;">
                    Is hereby granted accreditation as Continuing Education Online Training for Professionals.
                </p>
