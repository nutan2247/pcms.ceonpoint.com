                ...
                <div class="form-group">
                    <label for="status" class="col-sm-2 control-label">Status</label>
                        <div class="col-sm-10">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status0" value="0" <?php echo (isset($question->status) && $question->status == '0')? 'checked="checked"':''; ?>> Pendig

                            </label>

                            <label class="radio-inline">
                                <input type="radio" name="status" id="status2" value="2" <?php echo (isset($question->status) && $question->status =='2')? 'checked="checked"':''; ?>> Publish
