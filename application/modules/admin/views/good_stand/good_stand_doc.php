    ...
    <main>
        <div class="container-fluid">
                ...
                <div class="col-md-12 mx-auto v-div">
                    <div class="row mt-3 pb-3">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-2">
                                    <?php $rvd = $reqgoodstanddoc; //print_r($rvd);exit;
                                        if(!empty($rvd->image))
                                        {
                                    ?>
            ...
            <div class="card">
                ...
                <form role="form" class="form-horizontal form-groups-bordered validate" method="post" action="<?php echo base_url('reviewer/reviewer/verify_req_for_good_standing/'.$rvd->gs_id);?>">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-6 col-sm-5">
                            <input type="hidden" name="gs_id" id="gs_id" value="<?php echo $rvd->gs_id; ?>">
