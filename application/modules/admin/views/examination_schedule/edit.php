                        ...
                        <div class="col-sm-12">
                            <select class="form-control" name="set_no" id="set_no">
                                ...
                                <?php foreach($uniqueset as $value){ 
                                    if($question->set_no == $value->set_no){
                                        $selected = 'selected';
                                    }else{
                                        $selected = '';
                                    }?>
                                <option value="<?php echo $value->set_no; ?>" <?php echo $selected; ?> > <?php echo $value->set_no; ?> </option>
                                <?php } ?>
                    ...
                    <label for="status" class="col-sm-2 control-label">Status</label>
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status1" value="1" <?php echo (isset($question->status) && $question->status==1)? 'checked="checked"':''; ?>> Active
                            </label>

                            <label class="radio-inline">
                                <input type="radio" name="status" id="status0" value="0" <?php echo (isset($question->status) && $question->status !=1)? 'checked="checked"':''; ?>> Inactive
