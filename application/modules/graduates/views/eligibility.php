...
<div class="container">
    ...
    <div class="bg-light py-4">
        <div class="col-md-8 mx-auto">
            <div class="text-center">
                <h4 class="mb-4 text-uppercase text-center">Eligibility Certificate</h4>
                <h5 class="text-right"> Registration Code: <b><?php echo $profes_details->refrence_code; ?></b> </h5>
                <?php //print_r($profes_details);?>
                <!--<a href="#" onclick="viewCertificate('<?php echo $uid; ?>');">View Certificate</a> -->
    ...
    <table style="  width: 650px; padding:60px 15px 0 15px; display:block;margin: 0 auto; background-image: url('<?php echo $bg; ?>'); background-repeat: no-repeat; background-size: cover;">
        ...
        <tr style="text-align: center;">
            <td>
                <h1 style="font-family: 'Tangerine', cursive; font-size: 48px;font-weight: 700; margin: 0; "><?php echo ucwords($profes_details->student_name);?></h1>
                <span
                ...
                <p
                    ...
                    <?php echo date('F d,Y',strtotime($profes_details->review_accept_date))?></p>
                <p
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="email" id="emailAdderss" name="email" class="form-control" value="<?php echo $profes_details->email; ?>">
        </div>
